...
export function RegisterOneLastStepDialog({
  onSuccess,
  currentUserId
}: {
  ...
  return (
    <div
      css={styled}
      className="w-full flex flex-col items-start justify-center gap-10 relative bg-white overflow-hidden py-10"
    >
      <div className="relative flex justify-between items-center w-full px-10">
        <img className="w-[183px]" src={Logo} />
        <LanguageButton />
      </div>
      <div className="flex flex-col items-start gap-4 relative px-10">
      ...
      <div className="content-wrapper w-full flex flex-col gap-10 px-10">
        ...
        <div className="w-full flex flex-col gap-5">
          ...
          <div className="flex items-center justify-start gap-2">
            ...
            <div className="text-xs font-medium text-[#9E90CF]">
