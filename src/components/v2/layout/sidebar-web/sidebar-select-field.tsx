...
import { FormFieldApi } from '@/components/common/form-builder/type'
import { SidebarCustomSelect } from './sidebar-custom-select'

export interface SidebarSelectFieldProps {
  field: FormFieldApi
  label: string
  placeholder?: string
  className?: string
...
export const SidebarSelectField = (props: SidebarSelectFieldProps) => {
  const {
    field,
    label,
    placeholder,
