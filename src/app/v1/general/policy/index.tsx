  ...
  return (
    <div className="h-full overflow-hidden">
      <div className="flex-col gap justify-start items-start ">
        ...
        <div
          className="self-stretch rounded-[20px] p-5  border border-[#413c4a] justify-start items-start overflow-x-hidden lg:overflow-y-scroll scrollbar-thin scrollbar-track-transparent  
