...
import CryptocurrencyLogo from '@/assets/images/deposit/cryptocurrency-icon.svg'
      ...
      <div className={'mt-[60px] gap-[20px] flex w-full justify-start'}>
        {isSuccess ? (
          <CustomButton
            onClick={() => {
              navigate(
                `/deposit/${walletName}/cryptocurrency${location.search}`
              )
            }}
            className={'w-[150px] lg:w-[200px]'}
            label={t('deposit.details')}
            variant={'muted'}
          />
        ) : (
          <CustomButton
